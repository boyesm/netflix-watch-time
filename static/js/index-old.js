...
const tmdb_api_key = '237f6b5d8de5e8cd30158e7ca0215232';  // this needs to be removed!!!
...
let stats = {
    ...
    "year_labels": [],
    "average_time_watched_per_day_graph": [], // start with sunday
...
// gets uploaded file  // this is good enough
...
function processData() {
    ...
    const watch_data_json = convertCSVtoJSON(uploadedFile);
